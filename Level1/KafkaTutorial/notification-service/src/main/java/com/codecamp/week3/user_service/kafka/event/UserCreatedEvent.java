 ...
 */
package com.codecamp.week3.user_service.kafka.event;
...
public class UserCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2466409641462772943L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserCreatedEvent\",\"namespace\":\"com.codecamp.week3.user_service.kafka.event\",\"fields\":[{\"name\":\"id\",\"type\":\"long\",\"default\":0},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"\"},{\"name\":\"email\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"\"}]}");
   ...
   */
  public UserCreatedEvent(java.lang.Long id, java.lang.String name, java.lang.String email) {
    this.id = id;
    this.name = name;
    this.email = email;
  }
   ...
   */
  public static com.codecamp.week3.user_service.kafka.event.UserCreatedEvent.Builder newBuilder() {
    return new com.codecamp.week3.user_service.kafka.event.UserCreatedEvent.Builder();
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.codecamp.week3.user_service.kafka.event.UserCreatedEvent.Builder newBuilder(com.codecamp.week3.user_service.kafka.event.UserCreatedEvent.Builder other) {
    if (other == null) {
      return new com.codecamp.week3.user_service.kafka.event.UserCreatedEvent.Builder();
    } else {
      return new com.codecamp.week3.user_service.kafka.event.UserCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.codecamp.week3.user_service.kafka.event.UserCreatedEvent.Builder newBuilder(com.codecamp.week3.user_service.kafka.event.UserCreatedEvent other) {
    if (other == null) {
      return new com.codecamp.week3.user_service.kafka.event.UserCreatedEvent.Builder();
    } else {
      return new com.codecamp.week3.user_service.kafka.event.UserCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.codecamp.week3.user_service.kafka.event.UserCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.codecamp.week3.user_service.kafka.event.UserCreatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.codecamp.week3.user_service.kafka.event.UserCreatedEvent.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.codecamp.week3.user_service.kafka.event.UserCreatedEvent.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.codecamp.week3.user_service.kafka.event.UserCreatedEvent.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.codecamp.week3.user_service.kafka.event.UserCreatedEvent.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.codecamp.week3.user_service.kafka.event.UserCreatedEvent.Builder setEmail(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.codecamp.week3.user_service.kafka.event.UserCreatedEvent.Builder clearEmail() {
      email = null;
